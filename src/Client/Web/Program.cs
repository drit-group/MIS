...
namespace MisSystem.Client.Web;
...
public class Program
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("MisSystem.Client.Shared.wwwroot.appsettings.json"));
